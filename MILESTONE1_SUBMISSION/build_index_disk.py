...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        ...
        # User should provide path to dataset as argument
        print("Error: Please provide path to dataset directory")
        print("Usage: python3 build_index_disk.py <path_to_dataset>")
        sys.exit(1)
